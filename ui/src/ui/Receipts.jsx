...
export default function Receipts() {
  ...
  //   blockchainData.some((tx) => tx.timestamp === receipts.timestamp && tx.from === receipts.payer);
          ...
          <div className="grid grid-cols-2 gap-2 bg-gray-800 p-2 rounded transition-all duration-300 hover:scale-103 ease-in-out">
            ...
            <div className="flex gap-2 items-center">
              ...
              <span className="text-sm text-gray-300">
                {receipts?.payer?.slice(0, 7)}...{receipts?.payer?.slice(-5)}
              </span>
            </div>
            ...
            <div className="flex gap-2 items-center">
              <span>Company:</span>
              <span className="text-sm text-gray-300">
                {receipts?.company?.slice(0, 7)}...{receipts?.company?.slice(-5)}
              </span>
            </div>
