        ...
        <div className=" p-2  flex flex-col gap-6">
          <div className="grid gap-2">
            ...
            <p>
              ...
              aperiam necessitatibus, incidunt cupiditate nostrum laudantium a obcaecati commodi ipsum! Tenetur pariatur
              veritatis incidunt facilis harum?
            </p>
          </div>

          <div className="grid gap-2">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, dicta minima dolores nam culpa similique
              distinctio adipisci nemo, voluptatum a corporis consectetur natus. Placeat soluta vero ea mollitia fuga
              id.
            </p>
          </div>
          ...
          <div className="grid gap-2">
            <p>
              ...
              quaerat delectus dolorum voluptas consequuntur ipsa culpa doloremque quasi pariatur consequatur inventore
              asperiores alias? Sequi, vitae?
            </p>
          </div>
        </div>
      </CardContent>
